// 文章元数据：发布日期 + 最后修改日期（按发布日期倒序）
// key 匹配 Docsify hash 路由（#/docs/xxx）
window.$articleMeta = {
  'docs/blog-repo-evaluation-v1.md':           { published: '2026-06-24', modified: '2026-06-24' },
  'docs/高考备考-与乐乐深度谈心手册.md':             { published: '2026-06-18', modified: '2026-06-18' },
  'docs/甘肃省2025年高考分数一分一段深度分析及备考启示.md':   { published: '2026-06-17', modified: '2026-06-17' },
